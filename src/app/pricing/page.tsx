  ...
  return (
    <div className="oc-page-dark">
      ...
      <article className="mx-auto max-w-5xl px-5 py-10">
        <h1
          className="text-4xl mb-3 max-w-2xl oc-serif text-[var(--oc-cream)]"
        >
        ...
        <div className="grid gap-5 md:grid-cols-3 mt-10">
          <div className="oc-card p-6">
            ...
            <p className="text-sm text-[var(--oc-cream-muted)] leading-relaxed">
              One or two soft scenes. So you can see the faces lock. Limited saves. Optional watermark.
            </p>
          </div>
          <div className="oc-card p-6 ring-1 ring-[var(--oc-gold)]">
            <h2 className="text-2xl mb-2 oc-serif text-[var(--oc-cream)]">
              Couple
            </h2>
            <p className="text-3xl mb-2">$29–49<span className="text-base text-[var(--oc-cream-muted)]"> / month</span></p>
            <p className="text-sm text-[var(--oc-cream-muted)] leading-relaxed">
        ...
        <ul className="mt-10 text-sm text-[var(--oc-cream-muted)] space-y-2 max-w-xl">
        ...
        <p className="mt-6 text-sm text-[var(--oc-cream-muted)] max-w-xl">
          Heavy video will cost more than stills. We’ll show the cost before you run it.
        </p>

        <Link href="/signup" className="btn-oc-primary rounded-full px-5 py-2.5 text-sm font-semibold inline-block mt-8">
