    ...
    <div className="flex flex-col gap-5 w-full max-w-md">
      <div className="flex flex-wrap gap-3">
        <label className="inline-flex items-center cursor-pointer">
          ...
          <input type="file" accept="image/*" className="sr-only" onChange={handleFace} />
        </label>
        <label className="inline-flex items-center cursor-pointer">
          <span className="px-4 py-2.5 rounded-full border border-rose-300 bg-rose-50 text-rose-700 text-sm font-medium hover:bg-rose-100 active:bg-rose-200 transition select-none">
            Upload outfit photo
          </span>
          <input type="file" accept="image/*" className="sr-only" onChange={handleOutfit} />
        </label>
      </div>
      ...
      <select
        ...
        className="w-full rounded-full border border-rose-200 bg-white px-4 py-2.5 text-sm text-stone-800 focus:outline-none focus:ring-2 focus:ring-rose-300"
      >
      ...
      <button
        ...
        className="w-full px-8 py-2.5 rounded-full bg-rose-500 text-white text-sm font-semibold hover:bg-rose-600 disabled:opacity-55 disabled:cursor-not-allowed transition"
      >
